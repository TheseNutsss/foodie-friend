...
export default {
    ...
    actions: {
        ...
        async getPhotos({context, commit}, photoReference){
            const baseURL = 'http://http://localhost:3000/google-api?url=https://maps.googleapis.com/maps/api/place/photo'
        ...
        generateURL({state,dispatch}, params){
            ...
            const baseURL = 'http://http://localhost:3000/google-api?url=https://maps.googleapis.com/maps/api/place/nearbysearch/json'
            const API_KEY = process.env.VUE_APP_API_KEY
            const url = new URL(baseURL)
        ...
        async getPlaceDetails({commit, state}){
            ...
            const baseURL = 'http://http://localhost:3000/google-api?url=https://maps.googleapis.com/maps/api/place/details/json'
            const API_KEY = process.env.VUE_APP_API_KEY
            const url = new URL(baseURL)
            url.searchParams.set('key', API_KEY)
